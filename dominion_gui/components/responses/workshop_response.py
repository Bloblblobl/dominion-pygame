...
prompt_text = 'Select a card costing up to $4 to gain'
button_names = ['Done']


class WorkshopResponse(Response):
    def __init__(self,
                 card_names: List[str],
    ...
    def on_ui_button_press(self, *, ui_element):
        ...
        response_event = pygame.event.Event(
            pygame.USEREVENT,
            dict(user_type='custom_event', event=ResponseEvent('workshop', selected_card_name))
        )
